...
/**
 * 6×8 bitmap font - ASCII 32–127 (96 glyphs)
 * Column-major, LSB = topmost row of each column.
 * Each glyph = 6 bytes (one per column).
 *
 * Derived from classic 6×8 terminal font (public domain).
 */
